...
@section('title', 'Add Blog Category — SGCart Admin')
...
<div class="flex items-center gap-3 mb-6">
    ...
    <div>
        <h1 class="font-display text-2xl font-bold">Add Blog Category</h1>
        <x-breadcrumbs :items="[
...
<div class="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-xl shadow-sm w-full overflow-hidden">
    ...
    <form method="POST" action="{{ route('admin.blog-categories.store') }}" class="p-6 space-y-5">
        @csrf

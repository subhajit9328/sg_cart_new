...
@section('title', 'Add Blog Post — SGCart Admin')
...
<form method="POST" action="{{ route('admin.blog-posts.store') }}" enctype="multipart/form-data">
    ...
    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-6">
        <div class="flex items-center gap-3">
            ...
            <div>
                <h1 class="font-display text-2xl font-bold">Add Blog Post</h1>
                <x-breadcrumbs :items="[
            ...
            <div class="p-6 space-y-5">
                ...
                <div>
                    ...
                    <textarea name="summary" id="summary" rows="3"
                        ...
                        placeholder="Provide a brief summary of the post...">{{ old('summary') }}</textarea>
                </div>
            ...
            <div class="p-6 space-y-5">
                ...
                <div>
                    ...
                    <textarea name="meta_description" id="meta_description" rows="3"
                        class="w-full bg-slate-50 dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-lg py-2.5 px-3.5 text-sm placeholder:text-slate-400 outline-none focus:border-blue-500 focus:ring-1 focus:ring-blue-500 transition-all text-slate-800 dark:text-slate-100"
                        placeholder="Meta description for SEO optimization">{{ old('meta_description') }}</textarea>
                </div>
            ...
            <div class="p-6 space-y-4">
                ...
                <div class="border-t border-slate-100 dark:border-slate-850 pt-4">
                    ...
                    <div id="selectedProductsList" class="space-y-2 max-h-64 overflow-y-auto pr-1">
                        <!-- Dynamic items will append here -->
                    </div>
                </div>
            </div>
        </div>
...
<script>
    ...
    function addLinkedProduct(id, name, price, img) {
        ...
        container.innerHTML = `
            ...
            <button type="button" onclick="removeLinkedProduct('${id}')" class="text-slate-450 hover:text-rose-500 p-1 border-none bg-transparent cursor-pointer transition-colors">

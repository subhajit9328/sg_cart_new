...
@section('title', 'Edit Tax Rate — SGCart Admin')
...
<div class="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-xl shadow-sm w-full overflow-hidden">
    <div class="px-5 py-4 border-b border-slate-200 dark:border-slate-800 bg-slate-50/50 dark:bg-slate-900/50">
        <h2 class="font-semibold text-sm">Update Tax Rate Details</h2>
    </div>
    
    <form action="{{ route('admin.tax.update', $rate->id) }}" method="POST" class="p-6 space-y-5">
        @csrf
        @method('PUT')
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div>
                ...
                <select name="type" id="type" required
                    ...
                    <option value="percent" {{ old('type', $rate->type) == 'percent' ? 'selected' : '' }}>Percentage (%)</option>
            ...
            <div>
                ...
                <input type="number" step="0.01" min="0" name="rate" id="rate" value="{{ old('rate', $rate->rate) }}" required
        ...
        <div class="border-t border-slate-100 dark:border-slate-800 pt-4">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                ...
                <div>
                    ...
                    <input type="text" name="country" id="country" value="{{ old('country', $rate->country) }}"
                ...
                <div>
                    ...
                    <input type="text" name="state" id="state" value="{{ old('state', $rate->state) }}"
                ...
                <div>
                    ...
                    <input type="text" name="zip" id="zip" value="{{ old('zip', $rate->zip) }}"
                        class="w-full bg-slate-50 dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-lg py-2.5 px-3.5 text-sm placeholder:text-slate-400 outline-none transition-all text-slate-800 dark:text-slate-100"

...
namespace SGCart\Tax\Console\Commands;
...
class UninstallCommand extends Command
{
     ...
     * @var string
     */
    protected $signature = 'sgcart:tax-uninstall';
     ...
     * @var string
     */
    protected $description = 'Roll back tax migrations and perform package clean up';
    ...
    {
        $this->info('Starting SGCart Tax uninstallation...');
        ...
        try {
            ...
            $this->info('SGCart Tax uninstallation completed successfully.');

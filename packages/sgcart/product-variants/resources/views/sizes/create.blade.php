...
@section('title', 'Add Size Label — SGCart Admin')
...
<div class="flex items-center gap-3 mb-6">
    ...
    <div>
        <h1 class="font-display text-2xl font-bold">Add Size Label</h1>
        <x-breadcrumbs :items="[
...
<div class="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-xl shadow-sm w-full overflow-hidden max-w-2xl">
    <div class="px-5 py-4 border-b border-slate-200 dark:border-slate-800 bg-slate-50/50 dark:bg-slate-900/50">
        <h2 class="font-semibold text-sm">Enter Size Details</h2>
    </div>

    <form method="POST" action="{{ route('admin.sizes.store') }}" class="p-6 space-y-6">
        @csrf

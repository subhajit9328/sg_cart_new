...
namespace SGCart\Shipping\Console\Commands;
...
class UninstallCommand extends Command
{
     ...
     * @var string
     */
    protected $signature = 'sgcart:shipping-uninstall';
     ...
     * @var string
     */
    protected $description = 'Roll back shipping migrations and perform package clean up';
    ...
    {
        $this->info('Starting SGCart Shipping uninstallation...');
        ...
        try {
            ...
            $this->info('SGCart Shipping uninstallation completed successfully.');

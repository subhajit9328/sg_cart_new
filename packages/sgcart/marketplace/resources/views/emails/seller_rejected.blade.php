...
<head>
    ...
    <title>SG CART SELLER - Application Review Update</title>
    <style>
                    ...
                    <tr>
                        <td>
                            ...
                            <div class="content">
                                ...
                                <p class="body-text">
                                    Thank you for your interest in joining the SG CART marketplace. We have reviewed your store application (<strong>{{ $seller->shop_name }}</strong>).
                                </p>

                                <p class="body-text">
                                    Unfortunately, at this time we are unable to approve your application due to the following reason:
                                </p>
                                ...
                                <p class="body-text">
                                    If you would like to appeal this decision, clarify details, or update your information, please contact our support team at <a href="mailto:{{ config('mail.from.address', 'support@sgcart.com') }}">{{ config('mail.from.address', 'support@sgcart.com') }}</a>.
                                </p>

...
class SyncCommand extends Command
{
     ...
     * @var string
     */
    protected $signature = 'sgcart:coupons-sync';
     ...
     * @var string
     */
    protected $description = 'Sync coupons database schemas to match configuration settings';
    ...
    {
        $this->info('Syncing coupons features...');

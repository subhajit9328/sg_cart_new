...
<div class="relative bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-xl shadow-sm overflow-hidden">
    ...
    <div id="{{ $tableId }}_overlay" class="absolute inset-0 bg-white/60 dark:bg-slate-950/65 backdrop-blur-[1.5px] flex items-center justify-center hidden z-20 transition-all duration-300">

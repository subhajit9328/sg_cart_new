    ...
    <div class="wrapper">
        <div class="main-card">
            ...
            <div class="content">
                ...
                <p class="body-text">
                    You are receiving this email because you requested a password reset for your account at <strong>SG CART</strong>. To proceed with resetting your password, please use the following 6-digit OTP code:
                </p>
        ...
        <div class="footer">
            ...
            <p>You received this email because you requested a password reset at <a href="{{ config('app.url') }}">sgcart.com</a>.</p>
        </div>
    </div>
</body>
</html>
